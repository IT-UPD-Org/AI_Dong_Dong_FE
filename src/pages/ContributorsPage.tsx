    ...
    <section aria-labelledby="contributors-title" className="pb-12 pt-3 md:pt-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
        {contributors.map((contributor) => (
          <article
            key={contributor.id}
            className="group min-w-0 rounded-2xl border border-black/10 bg-white shadow-sm transition duration-300 hover:border-[#04714a]/25 hover:shadow-xl motion-safe:hover:-translate-y-1 motion-reduce:transition-none"
          >
            <div
              aria-hidden="true"
            ...
            >
              <span className="absolute -right-5 -top-12 size-44 rounded-full border-[24px] border-white/20 transition-transform duration-500 motion-safe:group-hover:translate-x-3 motion-safe:group-hover:translate-y-2" />
            </div>
            ...
            <div className="relative flex min-h-64 flex-col px-6 pb-5">
              ...
              <p className="mt-6 flex items-center gap-2 border-t border-black/[.07] pt-4 text-xs font-medium text-black/55">
                <span
                  aria-hidden="true"
      ...
      <dialog
        ...
        className="fixed inset-0 m-auto w-[calc(100%-2rem)] max-w-md overflow-hidden rounded-3xl border border-black/10 bg-white p-0 text-[#172b21] shadow-2xl backdrop:bg-[#172b21]/30 backdrop:backdrop-blur-sm"
      >
        {selected && (
          <>
            <div
